...
// Alles in orde, geen nieuwe fouten gevonden. 
...
function start(){              //level
    ...
    items['option_one'].onclick = function(){Ring()};
    items['option_two'].onclick = function(){Runaway()};
...
function Runaway(){             //Wegrennen
    ...
    items['option_one'].innerHTML= "TERUGRENNEN!";
    items['option_one'].onclick= function(){ start()
...
function monster(){           //Als je de sporen volgt
    ...
    if(enemy == true){
        ...
        items['option_one'].innerHTML= "Terug naar woonkamer";
        };
...
function Hide_base(){         //Als je naar de kelder gaat
    ...
    items['option_one'].onclick = function(){intro()};
        ...
        items['item'].style.cursor= "pointer";
        items['option_two'].onclick= function (){monster()};
        items['option_one'].onclick = function(){monster()};
        items['item'].onclick = function(){ 
...
function fight(){            //Vechten
    ...
    if(oppakken['wapen'] == true && oppakken['ammo'] == true){
        ...
        items['item'].onclick= function(){
            ...
            if(oppakken['goudensleutel'] == true){          
                items['item'].style.display= "none";
                items['option_one'].onclick= function(){Hide_base()};
            } else if(oppakken['goudensleutel'] == false){
                items['item'].style.display= "block";
                items['option_one'].onclick= function(){Hide_base()};  
            }
...
// function ToSlow(){
//     title.innerHTML= "Te langzaam!";
//     console.log(title.innerHTML);
//     document.getElementById("description").innerHTML= "Je was te traag met je keuze maken, het monster heeft je opgegeten!";
...
// window.setInterval(ToSlow,10000);
